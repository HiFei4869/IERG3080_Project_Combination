...
namespace PhysicEngine.Movement
{
	public class Movement
	{
		...
		public static void SplitEject(Planet planet, double x_c, double y_c)
        {
            //MessageBox.Show($"SplitEject: mouseX = {x_c}, mouseY = {y_c}", "Debug Information", MessageBoxButton.OK, MessageBoxImage.Information);
